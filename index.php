                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" <?php if (isset($_GET["msg"])) { echo 'placeholder=' + $_GET["msg"];} ?> name="message" required data-validation-required-message="Please enter a message."></textarea>
