                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" placeholder=<?php if (isset($_GET["msg"])) { echo $_GET["msg"];} else { echo "";} ?> name="message" required data-validation-required-message="Please enter a message."></textarea>
