                    ...
                    <form method="post" id="commentForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" novalidate>
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <textarea class="form-control" placeholder=<?php if (isset($_GET["msg"])) { echo $_GET["msg"];} else { echo "Your%20Message%20*";} ?> name="message" required data-validation-required-message="Please enter a message."></textarea>
